...
\tagpill{Computer Vision} \; \tagpill{Deep Learning} \; \tagpill{Reinforcement Learning} \; \tagpill{Efficient/Accelerated ML} \; \tagpill{Applied Statistics} \; \tagpill{NLP} \; \tagpill{Generative Models}
...
\begin{itemize}
  ...
  \item \textbf{Academic Interests}: Computer Vision, RL, Efficient ML, Generative Models
\end{itemize}
