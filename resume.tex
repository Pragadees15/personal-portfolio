...
\begin{tcolorbox}[resumeheader]
  \begin{tabularx}{\textwidth}{@{} X >{\raggedleft\arraybackslash}X @{} }
    ...
    \small \faMapMarker*\; Tiruvannamalai, IN \;|\; \faPhone\; +91-9943692130 & \small \faEnvelope\; \href{mailto:pragadees1323@gmail.com}{pragadees1323@gmail.com} \;|\; \faLinkedin\; \href{https://www.linkedin.com/in/pragadees-waran-a9280a253/}{LinkedIn} \;|\; \faGithub\; \href{https://github.com/Pragadees15}{GitHub} \;|\; \faGlobe\; \href{https://pragadeesportfolio.vercel.app/}{Portfolio} \\
  \end{tabularx}
\end{tcolorbox}
...
\tagpill{Computer Vision} \; \tagpill{Deep Learning} \; \tagpill{Representation Learning} \; \tagpill{Reinforcement Learning} \; \tagpill{Agentic AI} \; \tagpill{Efficient/Accelerated ML} \; \tagpill{Applied Statistics} \; \tagpill{NLP} \; \tagpill{Generative Models}
...
\begin{itemize}
  ...
  \item \textbf{Academic Interests}: Computer Vision, Representation Learning, RL, Agentic AI, Efficient ML, Generative Models
\end{itemize}
