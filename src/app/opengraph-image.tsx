...
export default async function Image() {
  ...
  if (!fontData) {
    throw new Error('Failed to load any font for Open Graph image generation');
  }
  ...
  try {
    ...
    console.warn('Failed to fetch avatar for Open Graph image, using URL directly:', error);
  }
