  ...
  useEffect(() => {
    ...
    try {
      ...
      if (raw) {
        ...
        frame = requestAnimationFrame(() => setState((s) => ({ ...s, ...saved })));
      }
    } catch { }
    return () => {
